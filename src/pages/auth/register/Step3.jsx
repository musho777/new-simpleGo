...
import { selectOtpToken, setRegistrationStep } from 'features/auth/authSlice';
import * as Yup from 'yup';

import { Form, Icon } from '../Auth.styles';
import { ErrorItem, ErrorList } from './Register.styles';
...
const Step3 = () => {
  ...
  const onSubmit = (data) => {
    const { password } = data;
    dispatch(setRegistrationStep('stepFour'));
