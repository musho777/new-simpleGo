...
import { getPaidPreviousInactiveReport } from 'modules/billing/features/main/mainActions';
...
const PaidPreviousInactiveFilter = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const result = await dispatch(getPaidPreviousInactiveReport(params));
      ...
      if (result.payload && result.payload instanceof Blob) {
        ...
        link.setAttribute(
          'download',
          `paid-previous-inactive-${selectedMonth}-${new Date().toISOString().split('T')[0]}.xlsx`
        );
