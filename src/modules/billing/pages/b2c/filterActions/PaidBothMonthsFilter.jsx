...
import { getPaidBothMonthsReport } from 'modules/billing/features/main/mainActions';
...
const PaidBothMonthsFilter = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const result = await dispatch(getPaidBothMonthsReport(params));
      ...
      if (result.payload && result.payload instanceof Blob) {
        ...
        link.setAttribute(
          'download',
          `paid-both-months-${selectedMonth}-${new Date().toISOString().split('T')[0]}.xlsx`
        );
