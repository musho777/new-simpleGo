...
import { getAllCustomersReport } from 'modules/billing/features/main/mainActions';
...
const AllCustomersFilter = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const result = await dispatch(getAllCustomersReport(params));
      ...
      if (result.payload && result.payload instanceof Blob) {
        ...
        link.setAttribute(
          'download',
          `all-customers-${new Date().toISOString().split('T')[0]}.xlsx`
        );
...
export default AllCustomersFilter;
